...
CMPP_CONNECT_REQ = 0x00000001
CMPP_CONNECT_RESP = 0x80000001

CMPP_TERMINATE_REQ = 0x00000002
CMPP_TERMINATE_RESP = 0x80000002

CMPP_SUBMIT_REQ = 0x00000004
CMPP_SUBMIT_RESP = 0x80000004

CMPP_DELIVER_REQ = 0x00000005
CMPP_DELIVER_RESP = 0x80000005

CMPP_QUERY_REQ = 0x00000006
CMPP_QUERY_RESP = 0x80000006

CMPP_CANCEL_REQ = 0x00000007
CMPP_CANCEL_RESP = 0x80000007

CMPP_ACTIVE_TEST_REQ = 0x00000008
CMPP_ACTIVE_TEST_RESP = 0x80000008

CMPP_FWD_REQ = 0x00000009
CMPP_FWD_RESP = 0x80000009

CMPP_MT_ROUTE_REQ = 0x00000010
CMPP_MT_ROUTE_RESP = 0x80000010

CMPP_MO_ROUTE_REQ = 0x00000011
CMPP_MO_ROUTE_RESP = 0x80000011

CMPP_GET_ROUTE_REQ = 0x00000012
CMPP_GET_ROUTE_RESP = 0x80000012

CMPP_MT_ROUTE_UPDATE_REQ = 0x00000013
CMPP_MT_ROUTE_UPDATE_RESP = 0x80000013

CMPP_MO_ROUTE_UPDATE_REQ = 0x00000014
CMPP_MO_ROUTE_UPDATE_RESP = 0x80000014

CMPP_PUSH_MT_ROUTE_UPDATE_REQ = 0x00000015
CMPP_PUSH_MT_ROUTE_UPDATE_RESP = 0x80000015

CMPP_PUSH_MO_ROUTE_UPDATE_REQ = 0x00000016
CMPP_PUSH_MO_ROUTE_UPDATE_RESP = 0x80000016

CMPP_GET_MO_ROUTE_REQ = 0x00000017
